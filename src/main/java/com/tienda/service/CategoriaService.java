...
public class CategoriaService {
    ...
    if(activo){ // si quiero solos los activos
   ...
   return categoriaRepository.findById(idCategoria);
    ...
    //si en idCategoria no esta definido se inserta un registro
    //si en idCategoria si esta definido se modifica un registro
    @Transactional
